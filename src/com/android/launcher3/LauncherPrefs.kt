...
constructor(@ApplicationContext private val encryptedContext: Context) {
    ...
    companion object {
        ...
        @JvmField val DOCK_SEARCH_WIDGET = backedUpItem("pref_dock_search_widget", "default")
        ...
        @JvmField val ICON_BG_SHAPE_ENABLED = backedUpItem("pref_icon_bg_shape_enabled", false)
